<form id="smpl_order" method="{{method}}" action="{{URI}}" >
  <div id="smpl_orderbox" class="smpl_order_box" >{{order}}:<select id="smpl_sortsource" class="smpl_sortsource" name="smpl_sortsource" title="{{source_of_order}}">
		...
		<select id="smpl_sort" class="smpl_sort" name="smpl_sort" title="{{Direction_of_order}}" width="40">
			<option value="-">-</option>
		...
		</select>{{filterform}}{{Filter}}:<select id="smpl_filtersource" class="smpl_filtersource" name="smpl_filtersource" title="{{Source_of_filter}}">
			<option value="-">-</option>
