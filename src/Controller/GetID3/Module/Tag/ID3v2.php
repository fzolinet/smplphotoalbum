...
namespace Drupal\smplphotoalbum\Controller\GetID3\Module\Tag;
...
class ID3v2 extends Handler
{
	...
	public function ParseID3v2Frame(&$parsedFrame) {
		...
		if (isset($parsedFrame['datalength']) && ($parsedFrame['datalength'] == 0)) {
			...
			$parsedFrame['description'] = trim(Utils::iconv_fallback($parsedFrame['encoding'], $info['id3v2']['encoding'], $parsedFrame['description']));
...
*/
						...
						if (!is_dir($dir) || !Utils::isWritable($dir)) {
							// cannot write, skip
