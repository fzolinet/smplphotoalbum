...
use Drupal\smplphotoalbum\Controller\GetID3\Module\Tag\ID3v1 as Tag;
...
class ID3v1
{
	...
	public function WriteID3v1() {
		...
		if (!empty($this->filename) && is_readable($this->filename) && Utils::isWritable($this->filename) && is_file($this->filename)) {
