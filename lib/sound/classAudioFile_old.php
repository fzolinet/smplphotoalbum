...
class AudioFile
{
    ...
    $g   = "\n\t\t\t";
		...
		{
			$str .= $g."  <tr>";
			$str .= $g."    <td align=right>id3v1-tags</td>";
			$str .= $g."    <td>";
			$str .= $g."      <table border=0>";
			$str .= $g."        <tr><td align=right>".t('title').":</td><td>$this->id3_title</td></tr>";
			$str .= $g."        <tr><td align=right>".t('artist').":</td><td>$this->id3_artist</td></tr>";
			$str .= $g."        <tr><td align=right>".t('album').":</td><td>$this->id3_album</td></tr>";
			$str .= $g."        <tr><td align=right>".t('year').":</td><td>$this->id3_year</td></tr>";
			$str .= $g."        <tr><td align=right>".t('comment').":</td><td>$this->id3_comment</td></tr>";
			$str .= $g."        <tr><td align=right>".t('genre').":</td><td>$this->id3_genre</td></tr>";
			$str .= $g."      </table>";
			$str .= $g."    </td>";
			$str .= $g."  </tr>";
		}
		...
		if ( isset($this->id3v2) && $this->id3v2)
		{
			fz_test($this->id3v2);
			$str .= $g."  <tr>";
			$str .= $g."    <td align=right>".t('id3v2-tags')."</td><td>";
			$str .= $g."    <td>";
			$str .= $g."      <table  border=0>";
			if(isset($this->id3v2->TIT2)){
				$out = mb_convert_encoding($this->id3v2->TIT2,'UTF-8' );
				$str .=  $g."      <tr><td align=right>".t('title').":</td><td>".$out."</td></tr>";
			}
			if(isset($this->id3v2->TPE1))$str .=  $g."      <tr><td align=right>".t('artist').":</td><td>".utf8_decode($this->id3v2->TPE1)."</td></tr>";
			if(isset($this->id3v2->TOPE))$str .=  $g."      <tr><td align=right>".t('original artist').":</td><td>".utf8_decode($this->id3v2->TOPE)."</td></tr>";
			if(isset($this->id3v2->TALB))$str .=  $g."      <tr><td align=right>".t('album').":</td><td>".utf8_decode($this->id3v2->TALB)."</td></tr>";
			if(isset($this->id3v2->TYER))$str .=  $g."      <tr><td align=right>".t('year').":</td><td>".$this->id3v2->TYER."</td></tr>";
			if(isset($this->id3v2->COMM))$str .=  $g."      <tr><td align=right>".t('comment').":</td><td>".utf8_decode($this->id3v2->COMM)."</td></tr>";
			if(isset($this->id3v2->TCOM))$str .=  $g."      <tr><td align=right>".t('composer').":</td><td>".utf8_decode($this->id3v2->TCOM)."</td></tr>";
			if(isset($this->id3v2->TCON))$str .=  $g."      <tr><td align=right>".t('genre').":</td><td>".utf8_decode($this->id3v2->TCON)."</td></tr>";
			if(isset($this->id3v2->TENC))$str .=  $g."      <tr><td align=right>".t('encoder').":</td><td>".utf8_decode($this->id3v2->TENC)."</td></tr>";
			if(isset($this->id3v2->WXXX))$str .=  $g."      <tr><td align=right>".t('website').":</td><td>".utf8_decode($this->id3v2->WXXX)."</td></tr>";
			$str .=  $g."      </table>";
			$str .=  $g."    </td>";
			$str .=  $g."  </tr>";
fz_die($str);
		...
		{
			$str .=  $g."  <tr>";
		  $str .=  $g."    <td align=right>ogg-tags</td>";
		  $sts .=  $g."    <td>";
			$str .=  $g."      <table border=0>";
			$str .=  $g."      <tr><td width=70 align=right>".t('title').":</td><td>".$this->vorbis_comment->TITLE."</td></tr>";
			$str .=  $g."      <tr><td align=right>".t('artist').":</td><td>".$this->vorbis_comment->ARTIST."</td></tr>";
			$str .=  $g."      <tr><td align=right>".t('album').":</td><td>".$this->vorbis_comment->ALBUM."</td></tr>";
			$str .=  $g."      <tr><td align=right>".t('date').":</td><td>".$this->vorbis_comment->DATE."</td></tr>";
			$str .=  $g."      <tr><td align=right>".t('genre').":</td><td>".$this->vorbis_comment->GENRE."</td></tr>";
			$str .=  $g."      <tr><td align=right>".t('comment').":</td><td>".$this->vorbis_comment->COMMENT."</td></tr>";
			$str .=  $g."      </table>";
			$str .=  $g."    </td>";
			$str .=  $g."  </tr>";
		}
